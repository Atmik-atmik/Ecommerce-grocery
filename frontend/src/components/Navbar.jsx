...
const Navbar = () => {
  ...
  const isActive = (path) => {
    return location.pathname == path
      ? "text-[var(--color-secondary)] border-b border-[var(--color-primary)]"
      : "";
  };
  const logout = () => {
    setUser(null);
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {user ? (
            ...
            <div className="absolute right-0  w-40 bg-[var(--color-secondary)] shadow-lg rounded-lg opacity-0 group-hover:opacity-100 group-hover:visible invisible transition duration-300 z-50 ">
              <ul>
                <p
                  ...
                  className="cursor-pointer hover:bg-[var(--color-primary)] py-1 px-3 "
                >
                  My Orders
                </p>
                <p
          ...
          <button
            ...
            className="cursor-pointer px-8 py-2 bg-[var(--color-primary)] hover:bg-[var(--color-secondary)] transition text-white rounded-full"
          >
            Login
          </button>
        )}
